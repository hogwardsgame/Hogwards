...
ZONES = {
    "forbidden_forest": {
        ...
        "monsters": ["acromantula", "centaur", "hippogriff", "bowtruckle", "niffler"],
        "boss": "aragog",
        "boss_every": 5,
        "main_boss_kills": 25,
    ...
    "azkaban": {
        ...
        "monsters": ["dementor", "troll", "dark_spirit"],
    ...
    "chamber_of_secrets": {
        ...
        "monsters": ["basilisk_child", "serpent", "slytherin_ghost"],
        "boss": "basilisk",
        "boss_every": 5,
        "main_boss_kills": 25,
    ...
    "gringotts_caves": {
        ...
        "monsters": ["guardian_dragon", "goblin", "cursed_relic"],
    ...
    "voldemort_castle": {
        ...
        "monsters": ["death_eater", "nagini", "dark_wizard"],
        "boss": "voldemort",
        "boss_every": 5,
        "main_boss_kills": 25,
    ...
    "hogwarts_dungeons": {
        ...
        "monsters": ["peeves", "dungeon_ghost", "animated_suit"],
        "boss": "bloody_baron",
        "boss_every": 5,
        "main_boss_kills": 20,
    ...
    "black_lake": {
        ...
        "monsters": ["grindylow", "merrow", "giant_squid_tentacle"],
        "boss": "lake_guardian",
        "boss_every": 5,
        "main_boss_kills": 20,
